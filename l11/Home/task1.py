...
# Вам необходим класс, который будет представлять строки журнала и включать в себя информацию
...
class MyStr(str):
    ...
    def __repr__(self):
        return f"{self.__class__.__name__}{(self.value, self.author)}"


mstr = MyStr("It's my string", "Marsel")
print(repr(mstr))
